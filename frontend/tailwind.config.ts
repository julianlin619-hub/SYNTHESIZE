...
export default {
	...
	theme: {
		...
		extend: {
			...
			textShadow: {
				'neon-blue': 'var(--text-glow-blue)',
				'neon-pink': 'var(--text-glow-pink)',
				'neon-green': 'var(--text-glow-green)'
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			keyframes: {
				glow: {
					'0%': { boxShadow: '0 0 5px hsl(var(--neon-blue)), 0 0 10px hsl(var(--neon-blue)), 0 0 15px hsl(var(--neon-blue))' },
					'100%': { boxShadow: '0 0 10px hsl(var(--neon-blue)), 0 0 20px hsl(var(--neon-blue)), 0 0 30px hsl(var(--neon-blue))' }
				}
			}
		}
	},
